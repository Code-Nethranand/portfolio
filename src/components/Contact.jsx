  ...
  return (
    ...
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="flex items-center gap-2 mt-auto ">
                    ...
                    (
                        <a
                            href={href}
                            target="_blank"
                            className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-colors, colors] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                            key={key}
            ...
            <form 
                action="https://getform.io/f/apjnplea" 
                method="POST"
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <input 
                            ...
                            autoComplete="email"
                            required
                            placeholder="nethranand@example.com"
                            className="text-field" 
                        />
                    </div>
                </div>
